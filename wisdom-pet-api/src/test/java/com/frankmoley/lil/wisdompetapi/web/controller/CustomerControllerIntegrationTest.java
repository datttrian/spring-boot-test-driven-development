package com.frankmoley.lil.wisdompetapi.web.controller;
...
public class CustomerControllerIntegrationTest {
    ...
    void updateCustomer() throws Exception {
        ...
        String jsonString = mapper.writeValueAsString(customer);
        this.mockMvc
                .perform(put("/customers/c04ca077-8c40-4437-b77a-41f510f3f185").content(jsonString)
    ...
    void updateCustomer_badRequest() throws Exception {
        ...
        ObjectMapper mapper = new ObjectMapper();
        String jsonString = mapper.writeValueAsString(customer);
        this.mockMvc.perform(put("/customers/2b31469c-da3d-469f-9900-d00b5e4e352f").content(jsonString)
